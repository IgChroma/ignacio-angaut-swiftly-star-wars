      ...
      <BracketBoxContainer>
         <BracketBox>
            ...
            <div>
               ...
               <PeopleCardItem></PeopleCardItem>
               <PeopleCardItem>Gender: {gender}</PeopleCardItem>
               <PeopleCardItem>Birth Year: {birth_year}</PeopleCardItem>
               <PeopleCardItem>
                  Homeworld:{' '}
                  <span style={{ color: planetColorMap[homeworldName]?.color }}>
                     {homeworldName}
                  </span>
                  {homeworldName && (
                     <PlanetContainer title={homeworldName}>
                        <PlanetLogo
                           planetData={planetColorMap[homeworldName]}
                        />
                     </PlanetContainer>
                  )}
               </PeopleCardItem>
               <CardButton onClick={() => setShowMore(!showMore)}>
                  More Details
               </CardButton>
            </div>
